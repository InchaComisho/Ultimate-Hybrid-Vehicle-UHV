...
|---|---|
| Vehicles | 100 |
| Mist output per vehicle | 5.0 L/hr |
| Operating hours | 8.0 hr |
| Ambient temperature | 40.0 °C |
| Relative humidity | 25.0 % |
| Wind speed | 2.0 m/s |
| Road corridor width | 30.0 m |
| Mixing height | 5.0 m |
| Vehicle speed | 30.0 km/h |
| Evaporation efficiency | 0.55 |
| Coverage efficiency | 0.35 |
| Heat loss / dilution factor | 0.6 |
| Max temperature drop cap | 5.0 °C |

## Illustrative Estimates

| Output | Value |
|---|---|
| Total mist water use per hour | 500.0 L/hr |
| Total water use over operating hours | 4000.0 L |
| Raw latent cooling power | 340.28 kW |
| Effective cooling power (after efficiency) | 26.20 kW |
| Estimated corridor temperature drop | 0.521 °C (capped at 5.0 °C) |
| Uncapped raw temperature estimate | 0.521 °C |

**Humidity note:** Low humidity - evaporative cooling conditions may be favorable.
